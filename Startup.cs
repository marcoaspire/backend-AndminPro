...
namespace _04_API_HospitalAPP
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "_04_API_HospitalAPP", Version = "v1" });
            });
        ...
        {
            //Creating a index page to go to on launch 
            app.UseDefaultFiles();
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "_04_API_HospitalAPP v1"));
            }
